...
const darDeBaja = (tipoDeBaja) => async (req, res) => {
    const { FICHA } = req.params;
    const { Usuario } = req.user;

    try {
        await adminModel.updateEstado(FICHA, Usuario, tipoDeBaja);
...
module.exports = { editarClienteForm, editarClientePost, editarFichaForm, darDeBaja, editarFichaPost, cargarClavo }
